...
class ObjectDetector:
    def __init__(self, weights_path, roi_intrusion, roi_no_parking, intrusion_time_threshold, loitering_time_threshold=10):
    ...
    def detect_and_draw(self, frame):
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    # 불법 주차 감지 로직
                        ...
                        cv2.putText(frame, 'Ilegal Parking', (int(xyxy[0]), int(xyxy[1]) - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 0, 0), 2)
        ...
        self.tracked_objects = {k: v for k, v in self.tracked_objects.items() if current_time - v['start_time'] <= self.loitering_time_threshold}
